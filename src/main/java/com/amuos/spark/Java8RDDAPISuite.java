...
public class Java8RDDAPISuite implements Serializable {
  ...
  public static void main(String[] args) {
    ...
    sparkConf.setJars(new String[]{"target/spark-and-friends-1.0-SNAPSHOT.jar"});
    sc = new JavaSparkContext("spark://localhost:7077", "JavaAPISuite", sparkConf);

//    foreachWithAnonymousClass(sc);
//    groupBy(sc);
    leftOuterJoin(sc);
  ...
  public static void foreachWithAnonymousClass(JavaSparkContext sc) {
    foreachCalls = 0;
  ...
  public static void groupBy(JavaSparkContext sc) {
  ...
  public static void leftOuterJoin(JavaSparkContext sc) {
  ...
  public static void foldReduce(JavaSparkContext sc) {
    JavaRDD<Integer> rdd = sc.parallelize(Arrays.asList(1, 1, 2, 3, 5, 8, 13));
  ...
  public void foldByKey(JavaSparkContext sc) {
  ...
  public static void mapsFromPairsToPairs(JavaSparkContext sc) {
  ...
  public static void sequenceFile(JavaSparkContext sc) {
  ...
  public static void zip(JavaSparkContext sc) {
    JavaRDD<Integer> rdd = sc.parallelize(Arrays.asList(1, 2, 3, 4, 5));
  ...
  public static void zipPartitions(JavaSparkContext sc) {
  ...
  public static void keyBy(JavaSparkContext sc) {
  ...
  public static void mapOnPairRDD(JavaSparkContext sc) {
  ...
  public static void collectPartitions(JavaSparkContext sc) {
  ...
  public static void collectAsMapWithIntArrayValues(JavaSparkContext sc) {
